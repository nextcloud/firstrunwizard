const __vite__fileDeps=[OC.filePath('firstrunwizard', '', 'js/main-BR4qyIrQ.mjs'),OC.filePath('firstrunwizard', '', 'css/firstrunwizard-main.css')],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
