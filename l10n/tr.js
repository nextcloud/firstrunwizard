OC.L10N.register(
    ...
    "App recommendation: Social" : "Önerilen uygulama: Sosyal ağ",
    ...
    "Communication with Nextcloud Talk" : "Nextcloud Sohbet ile İletişim Kurun",
    ...
    "Set up sync clients using an <a href=\"%s\">app password</a>. That way you can make sure you are able to revoke access in case you lose that device." : "<a href=\"%s\">uygulama şifresi</a>ile eşitleme istemcilerini kur. Bu şekilde cihazını kaybettiğinde erişimi sonlandırabileceğinden emin olabilirsin.",
    "Connect other apps to %s" : "Diğer uygulamaları %s üzerine bağlayın",
    "Besides the mobile apps and desktop client you can connect any other software that supports the WebDAV/CalDAV/CardDAV protocols to %s." : "Mobil uygulamalar ve masaüstü istemciler haricinde aynı zamanda WebDAV/CalDAV/CardDAV protokolü ile %s bağlanabilen diğer yazılımları ile de bağlanabilirsin.",
