OC.L10N.register(
    ...
    "Sync your files across your devices with the desktop and mobile apps, and connect your calendar and contacts." : "Dosyalarınızı masaüstü ve mobil uygulamalarla aygıtlarınız arasında eşitleyin, takviminizi ve kişilerinizi ilişkilendirin.",
    ...
    "Introducing Nextcloud Hub {version}" : "Nextcloud Hub {version} sürümü tanıtıldı",
    ...
    "Read the Nextcloud Hub {version} blog" : "Nextcloud Hub {version} günlüğünü okuyun",
    "Share your opinion about Nextcloud Hub {version}" : "Nextcloud Hub {version} hakkındaki düşüncelerinizi paylaşın",
    "Share via email" : "E-posta ile paylaşın",
    "Share on {socialMedia}" : "{socialMedia} üzerinde paylaşın",
    "Nextcloud Hub {version} release" : "Nextcloud Hub {version} yayınlandı",
    "Read more about it on the Nextcloud Hub {version} blog" : "Nextcloud Hub {version} günlüğünden ayrıntılı bilgi alın",
    "New in Nextcloud Hub {version}" : "Nextcloud Hub {version} yenilikleri",
    "Connect other apps to {productName}" : "{productName} ile diğer uygulamaları bağlayın",
    "Besides the mobile apps and desktop client you can connect any other software that supports the WebDAV/CalDAV/CardDAV protocols to {productName}." : "Mobil ve masaüstü istemci uygulamaları yanında WebDAV/CalDAV/CardDAV iletişim kurallarını destekleyen uygulamalar da {productName} ile bağlantı kurabilir.",
    ...
    "Get to know the new features of Hub 9" : "Yeni Hub 9 özellikleri ile ilgili bilgi alın",
    ...
    "This Nextcloud is on version " : "Bu Nextcloud sürümü ",
    "Assistant: chat summaries, Mail reply suggestions, answers based on your data, and more" : "Yardımcı: Sohbet özetleri, e-posta yanıtı önerileri, verilerinize göre yanıtlar ve diğer özellikler",
    "Interactive previews for files, folders, boards and events" : "Dosyalar, klasörler, panolar ve etkinlikler için etkileşimli ön izlemeler",
    "Federated chat and message editing in Talk" : "Talk üzerinde birleşik sohbet ve ileti düzenleme",
    "Mini-apps based on Tables" : "Tablolar uygulmasını kullanan mini uygulamalar",
    "Manage your team resources like a pro with Nextcloud Teams" : "Nextcloud Teams ile profesyonelce yönetebileceğiniz ekip kaynakları",
    "Forms: automatically sync with a spreadsheet" : "Formlar: Bir e-tabloyla otomatik olarak eşitleme",
    "Get to know the new features of Hub 8" : "Yeni Hub 8 özellikleri ile ilgili bilgi alın"
},
