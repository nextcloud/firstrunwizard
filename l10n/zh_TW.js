OC.L10N.register(
    ...
    "Besides the mobile apps and desktop client you can connect any other software that supports the WebDAV/CalDAV/CardDAV protocols to %s." : "除了行動裝置 apps 及桌面客戶端，您可以連結任何其他支援 WebDAV/CalDAV/CardDAV 協定的軟體到%s 。",
