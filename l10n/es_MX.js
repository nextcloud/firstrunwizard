OC.L10N.register(
    ...
    "Nextcloud Project" : "Proyecto de Nextcloud",
    "Nextcloud Whiteboard" : "Pizarrón de Nextcloud",
    "Workflow Engine" : "Motor de flujo de trabajo",
    "Safer and swifter mail" : "Correo más seguro y rápido",
    "Public Collectives sharing, previews and QR-codes" : "Intercambio de colectivos públicos, vistas previas y códigos QR",
    ...
    "Assistant: chat summaries, Mail reply suggestions, answers based on your data, and more" : "Asistente: resúmenes de chat, sugerencias de respuestas de correo, respuestas basadas en sus datos, y más",
    "Interactive previews for files, folders, boards and events" : "Vistas previas interactivas para archivos, carpetas, tableros y eventos",
    "Federated chat and message editing in Talk" : "Chat federado y edición de mensajes en Talk",
    "Mini-apps based on Tables" : "Mini aplicaciones basadas en Tables",
    "Manage your team resources like a pro with Nextcloud Teams" : "Administre los recursos de su equipo como un profesional con Nextcloud Teams",
    "Forms: automatically sync with a spreadsheet" : "Formularios: sincronización automática con una hoja de datos",
    "Get to know the new features of Hub 8" : "Conozca las nuevas características de Hub 8"
},
