OC.L10N.register(
    ...
    "iOS app" : "تطبيق iOS",
    "About & What's new" : "حَوْلَ، و ما الجديد",
    ...
    "Extend the functionality of Nextcloud with hundreds of community-developed apps." : "وسِّع نطاق استعمالاتك لنكست كلاود من خلال المئات من التطبيقات المطورة من جماعة المصادر المفتوحة.",
    "Get involved! ↗" : "شارِك! ↗",
    ...
    "Find out more on the blog" : "لمزيد المعلومات، أنظُر المدونة",
    ...
    "Share on {socialMedia}" : "شارك على {socialMedia}",
    "Nextcloud Hub {version} release" : "رقم إصدار نكست كلاود هب {version}  ",
    "Read more about it on the Nextcloud Hub {version} blog" : "لمزيد المعلومات حول نكست كلاود هب {version}، أنظُر المدونة",
    "New in Nextcloud Hub {version}" : "الجديد في نكست كلاود هب {version}",
    "Connect other apps to {productName}" : "ربط تطبيقات أخرى مع {productName}",
    "Besides the mobile apps and desktop client you can connect any other software that supports the WebDAV/CalDAV/CardDAV protocols to {productName}." : "بالإضافة إلى تطبيقات الموبايل و عميل سطح المكتب، يمكنك التوصيل مع أي برمجيات أخرى تدعم بروتوكولات WebDAV/CalDAV/CardDAV: {productName}.",
    "Apps to connect to {productName}" : "تطبيقات ليتم ربطها مع {productName}",
    "Get the apps to sync your files" : "احصل على التطبيقات لمزامنة ملفاتك",
    "{productName} gives you access to your files wherever you are. Our easy to use desktop and mobile clients are available for all major platforms at zero cost." : "{productName} تُمكِّنك من الوصول إلى ملفاتك حيثما كنت. تطبيقاتنا سهلة الاستعمال للموبايل و سطح المكتب متاحة على كافة المنصات الشائعة بدون أي تكلفة.",
    ...
    "Nextcloud Project" : "مشروع نكست كلاود",
    ...
    "Chat mode for Nextcloud Assistant" : "وضعية الدردشة لمساعد نكست كلاود",
    "Get to know the new features of Hub 9" : "تعرَّف على المزايا الجديد لـ Hub 9",
    "What's new?" : "مالجديد؟",
    "Nextcloud on all your devices" : "نكست كلاود على جميع أجهزتك",
    "Nextcloud Hub {version}" : "نكست كلاود هب {version}",
    "Read more" : "إقرأ أكثر",
    ...
    "Become part of the Community" : "كُن عضواً في الجماعة",
    ...
    "You can also ask for help in our community support channels:" : "يُمكنك كذلك طلب العون في قنواتنا لدعم الجماعة: ",
    ...
    "100%% open source & community-focused" : "100%% مفتوح المصدر و جماعيَّ التّوَجُّه",
    ...
    "Assistant: chat summaries, Mail reply suggestions, answers based on your data, and more" : "المساعد: ملخصات الدردشة واقتراحات الرد عبر البريد والإجابات بناءً على بياناتك، والمزيد ....",
