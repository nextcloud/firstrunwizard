OC.L10N.register(
    ...
    "Besides the mobile apps and desktop client you can connect any other software that supports the WebDAV/CalDAV/CardDAV protocols to {productName}." : "Крім застосунків для смартфону та настільного клієнта ви можете приєднати інші програми з підтримкою протоколів WebDAV/CalDAV/CardDAV до {productName}.",
    "Apps to connect to {productName}" : "Застосунки, які можна приєднати до {productName}",
