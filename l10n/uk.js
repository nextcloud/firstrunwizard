OC.L10N.register(
    ...
    "Public Collectives sharing, previews and QR-codes" : "Можливість надавати у спільний доступ, попередній перегляд та підтримка QR-кодів для застосунку Collectives",
    "Office and PDF templates" : "Шаблони офісних документів та PDF",
    "Chat mode for Nextcloud Assistant" : "Режим чату для Асистента Nextcloud",
    "Get to know the new features of Hub 9" : "Дізнатися про нові функції у Hub 9",
