OC.L10N.register(
    ...
    "Assistant: chat summaries, Mail reply suggestions, answers based on your data, and more" : "Асистент, який допоможе підбити підсумки спількування у чаті, розумні пропозиції відповідей в електронних листах, формування відповідей на питання після опрацювання ваших даних тощо",
    ...
    "Manage your team resources like a pro with Nextcloud Teams" : "Керування ресурсами команд за допомогою застосунку Команди для Nextcloud",
    "Forms: automatically sync with a spreadsheet" : "Автоматична синхронізація даних застосунку Форми з електронними таблицями",
