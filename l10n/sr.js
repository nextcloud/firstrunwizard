OC.L10N.register(
    ...
    "If you want to support the project {contributeopen}join development{linkclose} or {contributeopen}spread the word{linkclose}!" : "Ако желите да подржите пројекат, {contributeopen}придружите се развоју{linkclose} или {contributeopen}проширите реч{linkclose}!",
    "Show First Run Wizard again" : "Прикажи чаробњака за прво покретање поново",
