OC.L10N.register(
    ...
    "App recommendation: Tasks" : "App recomendada:Tareas",
    ...
    "App recommendation: Social" : "App recomendada: Social",
    ...
    "Set up sync clients using an <a href=\"%s\">app password</a>. That way you can make sure you are able to revoke access in case you lose that device." : "Configura clientes de sincronización usando una <a href=\"%s\">contraseña de app</a>. De esta forma, puedes asegurarte de revocar el acceso si pierdes ese dispositivo.",
    "Connect other apps to %s" : "Conectar otras apps con %s",
    "Besides the mobile apps and desktop client you can connect any other software that supports the WebDAV/CalDAV/CardDAV protocols to %s." : "Además de las apps móviles y del cliente de escritorio, puedes conectar a %s cualquier otro programa que soporte los protocolos WebDAV\"CaldDAV/CardDAV.",
