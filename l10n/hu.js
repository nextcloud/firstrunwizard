OC.L10N.register(
    ...
    "About" : "Névjegy",
    "Start using {cloudName}" : "A(z) {cloudName} használatának megkezdése",
    "Extend your cloud" : "Bővítse a felhőjét",
    ...
    "Groupware apps like Calendar, Contacts, Mail" : "Csoportmunka alkalmazások mint a Naptár, a Névjegyek és a Levelezés",
    "Communication with Nextcloud Talk" : "Kommunikáció a Nextcloud Beszélgetés segítségével",
    "Collaboration apps for document editing" : "Csoportmunka alkalmazások dokumentumszerkesztéshez",
    "Security and authentication features like two-factor authentication, SSO and ransomware protection" : "Biztonsági és hitelesítési tulajdonságok, mint a kétlépcsős hitelesítés, SSO és a zsarolócírus elleni védelem.",
    "Many others like a music player, a password manager, a kanban app, a download manager or a Markdown editor" : "Sok más, mint zenelejátszó, jelszókezelő, kanban alkalmazás, letöltéskezelő vagy Markdown szerkesztő",
    "Browse the App Store" : "Alkalmazástár böngészése",
    "Stay in sync" : "Maradjon szinkronban",
    "Nextcloud gives you access to your files wherever you are." : "A Nextcloud hozzáférést biztosít a fájljaihoz, bárhol is legyen.",
    "Our easy to use desktop and mobile clients are available for all major platforms at zero cost!" : "A könnyen kezelhető asztali és mobil kliensek ingyenesen elérhetők az összes főbb platformon.",
    "Connect your desktop apps to %s" : "Asztali alkalmazások csatlakoztatása a %shoz",
    ...
    "If you run Nextcloud in a mission critical environment where security and compliance are important, you need the certainty of Nextcloud Enterprise." : "Ha a Nextcloudot kulcsfontosságú környezeteben használja, ahol a biztonság és a megfelelőség fontos, akkor szüksége van a Nextcloud Enterprise biztonságára.",
    "Learn more about Nextcloud Enterprise" : "Tudjon meg többet a Nextcloud Enterprise-ról",
