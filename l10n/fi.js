OC.L10N.register(
    ...
    "App recommendation: Whiteboard" : "Sovellussuositus: Whiteboard",
    "Create and share whiteboards with others and collaborate in real-time." : "Luo ja jaa valkotauluja muiden kanssa, ja tee yhteistyötä reaaliajassa.",
    ...
    "Nextcloud Hub {version} release" : "Nextcloud Hub {version} -julkaisu",
    "Read more about it on the Nextcloud Hub {version} blog" : "Lue lisää Nextcloud Hub {version} -blogista",
    "Find out more on the blog" : "Lue lisää blogista",
    "Read the Nextcloud Hub {version} blog" : "Lue Nextcloud Hub {version} -blogia",
    "Share via email" : "Jaa sähköpostitse",
    "Share on {socialMedia}" : "Jaa: {socialMedia}",
    "New in Nextcloud Hub {version}" : "Uutta Nextcloud Hubin versiossa {version}",
    "Connect other apps to {productName}" : "Yhdistä muita sovelluksia {productName}iin",
