...
"If you like ownCloud,\n\t<a href=\"mailto:?subject=ownCloud\n\t\t&body=ownCloud is a great open software to sync and share your files. \n\t\tYou can freely get it from http://owncloud.org\">\n\t\trecommend it to your friends</a>\n\tand <a href=\"http://owncloud.org/promote\"\n\t\ttarget=\"_blank\">spread the word</a>!" => "Εάν σας άρεσε το ownCloud,\n⇥<a href=\"mailto:?subject=ownCloud\n⇥⇥&body=Το ownCloud είναι ένα υπέροχο ανοιχτού κώδικα πρόγραμμα για να συγχρονίσετε και να μοιραστείτε τα αρχεία σας.\n⇥⇥Μπορείτε να το πάρετε ελεύθερα από το http://owncloud.org\">\n⇥⇥προτείνετέ το στους φίλους σας</a>\n⇥και <a href=\"http://owncloud.org/promote\"\n⇥⇥target=\"_blank\">διαδώστε το</a>!"
);
