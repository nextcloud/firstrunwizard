OC.L10N.register(
    ...
    "Start using {cloudName}" : "Byrjaðu að nota {cloudName}",
    ...
    "If you run Nextcloud in a mission critical environment where security and compliance are important, you need the certainty of Nextcloud Enterprise." : "Ef þú ert að nota Nextcloud fyrir mikilvæga vinnu þar sem þróað öryggi og samhæfni skipta mestu máli, þá ættirðu að nýta þér stöðugleika Nextcloud Enterprise fyrirtækjaútgáfunnar.",
    "Learn more about Nextcloud Enterprise" : "Sjáðu meira um Nextcloud fyrir fyrirtæki",
    ...
    "This Nextcloud is on version %s" : "Þetta Nextcloud er á útgáfu %s",
