OC.L10N.register(
    ...
    "Assistant: chat summaries, Mail reply suggestions, answers based on your data, and more" : "Assistant: samantekt úr spjalli, tillögur að svörum í pósti, svör byggð á gögnunum þínum, og margt fleira",
    "Interactive previews for files, folders, boards and events" : "Gagnvirkar forskoðanir á skrám, möppum, borðum og atburðum",
    "Federated chat and message editing in Talk" : "Spjall í skýjasambandi og meðhöndlun skilaboða í Talk-spjallinu",
    "Mini-apps based on Tables" : "Smáforrit byggð á Tables",
    "Public Collectives sharing, previews and QR-codes" : "Deiling opinberra safna, forskoðun og QR-kóðar",
    "Manage your team resources like a pro with Nextcloud Teams" : "Meðhöndlaðu tilföng teymisins þíns eins og atvinnumaður með Nextcloud Teams",
    "Forms: automatically sync with a spreadsheet" : "Forms: samstillir sjálfkrafa við töflureikna",
    "Get to know the new features of Hub 8" : "Kynntu þér nýja eiginleika í Hub 8",
