OC.L10N.register(
    ...
    "Next" : "Weiter",
    "Close" : "Schließen",
    "_icon-close icon-white_::_close_" : [".","."],
    "_fade_::_out-in_" : [".","."],
    "Start using Nextcloud" : "Starten Sie mit Nextcloud",
    "_modal-mask_::_firstrunwizard_" : [".","."],
