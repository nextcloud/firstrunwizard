OC.L10N.register(
    ...
    "Security and authentication features like two-factor authentication, SSO and randsomware protection" : "Sicherheits- und Authentifizierungsfunktionen wie Zwei-Faktor-Authentifizierung, SSO und Randsomeware-Schutz",
    "Many others like a music players, password managers, a kanban app, download manager or a markdown editor" : "Viele weitere wie z.B ein Musik-Player, ein Passwort-Manager, eine Kanban App, ein Download-Manager oder ein Markdown-Editor",
    ...
    "If you run Nextcloud in a mission critical environment with large numbers of users and big amounts of data and need the certainty of support from the experts behind the Nextcloud technology, a Enterprise Subscription from Nextcloud is available with email and phone support." : "Wenn Sie Nextcloud in einer missionskritischen Umgebung mit einer hohen Anzahl Nutzern und großen Datenmengen betreiben und die Sicherheit und Unterstützung der Experten hinter der Nextcloud Technologie benötigen, können Sie ein Enterprise Abo, verfügbar per Email und Telefon, erwerben.",
    ...
    "Host you data and files where you decide" : "Hosten Sie Ihre Daten und Dateien wo Sie möchten.",
