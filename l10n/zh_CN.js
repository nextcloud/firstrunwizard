OC.L10N.register(
    ...
    "Become part of the Community." : "成为社区中的一员",
    "Enterprise support" : "企业级技术支持",
    "Get enterprise support" : "获取企业级技术支持",
    "Host you data and files where you decide" : "把数据和文件保管在你想要的地方",
    ...
    "Setup sync clients using an <a href=\"\">app password</a>. That way you can make sure you are able to revoke access in case you loose that device." : "为同步文件的客户端设置一个 <a href=\"\">应用密码</a>，这样设备丢失的时候就可以取消它的访问权限了",
