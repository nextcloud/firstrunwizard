OC.L10N.register(
    ...
    "Assistant: chat summaries, Mail reply suggestions, answers based on your data, and more" : "助手：聊天摘要、邮件回复建议、基于您数据的回答等",
    "Interactive previews for files, folders, boards and events" : "文件、文件夹、看板和事件的交互式预览",
    "Federated chat and message editing in Talk" : "Talk 中的联合聊天和消息编辑",
    "Mini-apps based on Tables" : "基于表格的迷你应用",
    ...
    "Forms: automatically sync with a spreadsheet" : "表单：自动与电子表格同步",
