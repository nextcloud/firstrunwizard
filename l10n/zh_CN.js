OC.L10N.register(
    ...
    "Nextcloud becomes part of the federated social networks." : "Nextcloud 已经成为了联合社交网络的一部分。",
    ...
    "Many others like a music player, a password manager, a kanban app, a download manager or a markdown editor" : "还有很多应用如音乐播放器，密码管理器，看板app，下载管理器和markdown编辑器",
    ...
    "The Nextcloud documentation for home users:" : "适用家庭用户的Nextcloud文档：",
    "User manual" : "用户手册",
    "Admin manual" : "管理员手册",
    ...
    "Do you want to get a certain improvement in Nextcloud? Did you find a problem? Do you want to help translate, promote or document Nextcloud?" : "您想改进Nextcloud？您发现了一个问题？您想帮助翻译，促进Nextcloud或为其编写文档？",
    "Become part of the Community" : "成为社区的一分子",
    "Enterprise support" : "企业级技术支持",
    "If you run Nextcloud in a mission critical environment with large numbers of users and big amounts of data and need the certainty of support from the experts behind the Nextcloud technology, an Enterprise Subscription from Nextcloud is available with email and phone support." : "如果您在拥有海量用户和数据的关键任务环境中运行Nextcloud，需要Nextcloud技术背后的专家提供确定的支持，您可以购买Nextcloud的企业级订阅，享受邮件和电话支持。",
    "Get enterprise support" : "获取企业级技术支持",
    "A safe home for all your data" : "给您所有数据一个安全的家",
    "Nextcloud puts your data at your fingertips, under your control. Store your documents, calendar, contacts and photos on a server in your company, at home, at one of our providers or in a data center you know." : "Nextcloud将您的数据置于您的掌控之中。在您公司、家中、我们的一个供应商或您了解的数据中心里的服务器上保存您的文档、日历、联系人以及照片。",
