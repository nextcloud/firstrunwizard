OC.L10N.register(
    ...
    "App recommendation: Forms" : "Recomanació d'aplicació: Formularis",
    "Simple surveys and questionnaires, self-hosted" : "Enquestes i qüestionaris senzills, autoallotjats",
    "App recommendation: Recognize" : "Recomanació d'aplicació: Recognize",
    ...
    "Find more than 100 apps in the Nextcloud App Store to customize your cloud:" : "Descobriu més de 100 aplicacions al magatzem d’aplicacions Nextcloud per personalitzar el vostre núvol:",
    ...
    "Security and authentication features like two-factor authentication, SSO and ransomware protection" : "Funcions de seguretat i autenticació, com ara l'autenticació de doble factor, la protecció SSO i el ransomware",
    ...
    "Browse the App Store" : "Navegueu pel magatzem d’aplicacions",
    ...
    "Android app on Google Play Store" : "Aplicació per a Android a Google Play Store",
    "Android app on F-Droid" : "Aplicació d'Android a F-Droid",
    ...
    "Access files via WebDAV" : "Accediu als fitxers mitjançant WebDAV",
    ...
    "If you run Nextcloud in a mission critical environment where security and compliance are important, you need the certainty of Nextcloud Enterprise." : "Si executeu Nextcloud en un entorn de missió crítica on la seguretat i el compliment són importants, necessiteu la seguretat de Nextcloud Enterprise.",
    "Learn more about Nextcloud Enterprise" : "Més informació sobre Nextcloud Enterprise",
    ...
    "100%% open source & community-focused" : "100%% codi obert i centrat en la comunitat",
