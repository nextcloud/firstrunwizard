OC.L10N.register(
    ...
    "Start using {cloudName}" : "Comienza a usar {cloudName}",
    "Welcome to {cloudName}!" : "¡Bienvenido a {cloudName}!",
    "Extend your cloud" : "Amplía tu nube",
    "Find more than 100 apps in the Nextcloud App Store to customize your cloud:" : "Encuentra más de 100 aplicaciones en la Tienda de aplicaciones de Nextcloud para personalizar tu nube:",
    ...
    "Security and authentication features like two-factor authentication, SSO and ransomware protection" : "Funciones de seguridad y autenticación como autenticación de dos factores, SSO y protección contra ransomware",
    ...
    "Get support or participate" : "Obtén soporte o participa",
    ...
    "Become part of the Community" : "Únete a la comunidad",
    "Enterprise support" : "Soporte empresarial",
    "If you run Nextcloud in a mission critical environment where security and compliance are important, you need the certainty of Nextcloud Enterprise." : "Si utilizas Nextcloud en un entorno crítico donde la seguridad y el cumplimiento son importantes, necesitas la certeza de Nextcloud Enterprise.",
    "Learn more about Nextcloud Enterprise" : "Más información sobre Nextcloud Enterprise",
    ...
    "This Nextcloud is on version %s" : "Esta instancia de Nextcloud está en la versión %s",
