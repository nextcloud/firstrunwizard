OC.L10N.register(
    ...
    "Federated collaboration: file sharing, messaging, calls" : "Collaborazione federata: condivisione di file, messaggistica, chiamate",
    "Nextcloud Whiteboard" : "Lavagna di Nextcloud",
    "Workflow Engine" : "Motore del flusso di lavoro",
    "Safer and swifter mail" : "Email più sicura e leggera",
    ...
    "Assistant: chat summaries, Mail reply suggestions, answers based on your data, and more" : "Assistente: riassunti di chat, suggerimenti di risposta in Mail, risposte basate sui tuoi dati, e altro",
    "Interactive previews for files, folders, boards and events" : "Anteprime interattive per file, cartelle, lavagne ed eventi",
    "Federated chat and message editing in Talk" : "Chat federata e modifica dei messaggi in Talk",
    "Mini-apps based on Tables" : "Mini-app basate su Tables",
    "Manage your team resources like a pro with Nextcloud Teams" : "Gestisci le risorse del tuo team da professionista con Nextcloud Teams",
    "Forms: automatically sync with a spreadsheet" : "Forms: sincr. automatica con un foglio di calcolo",
    "Get to know the new features of Hub 8" : "Scopri le nuove caratteristiche di Hub 8"
},
