OC.L10N.register(
    ...
    "If you run Nextcloud in a mission critical environment where security and compliance are important, you need the certainty of Nextcloud Enterprise." : "Для развёртывания Nextcloud в критических окружениях, когда важна высокая безопасность и соответствие стандартам, разработано корпоративное решение Nextcloud Enterprise.",
    "Learn more about Nextcloud Enterprise" : "Узнать больше о Nextcloud Enterprise",
    ...
    "Open standards and interoperability" : "Открытые стандарты и функциональная совместимость",
    "100%% open source & community-focused" : "100%% открытый исходный код и ориентированность на сообщество",
    "Learn more about %s" : "Узнать больше о %s",
    "This Nextcloud is on version %s" : "Nextcloud версии %s",
