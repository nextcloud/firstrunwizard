OC.L10N.register(
    ...
    "If you like Nextcloud,\n\t<a href=\"mailto:?subject=Nextcloud\n\t\t&body=Nextcloud is a great open software to sync and share your files.\n\t\tYou can freely get it from https://nextcloud.com\">\n\t\trecommend it to your friends</a>\n\tand <a href=\"https://nextcloud.com/contribute/\"\n\t\ttarget=\"_blank\">contribute back</a>!" : "Εάν σας άρεσε το Nextcloud,\n\t<a href=\"mailto:?subject=Nextcloud\n\t\t&body=Το Nextcloud είναι λογισμικό ανοικτού κώδικα για τον συγχρονισμό και διαμοιρασμό αρχείων σας.\n\t\tΚατεβάστε το δωρεάν από  https://nextcloud.com\">\n\t\tσυστήστε το στους φίλους σας</a>\n\tκαι <a href=\"https://nextcloud.com/contribute/\"\n\t\ttarget=\"_blank\">συνεισφέρετε</a>!"
},
