...
* This repository ([First-run wizard](https://github.com/nextcloud/firstrunwizard/issues)) is *only* for issues within the First-run wizard code.
...
[template]: https://raw.github.com/nextcloud/firstrunwizard/master/.github/issue_template.md
